...
table1(~ age_mom_enroll_d + mom_firstperiod_12y + bmi_mom_prepreg_d + fish_d_f1 + 
         dark_meat_f1 + ahei_ffq1_n2128 + mod_pre_d + vig_pre_d + exer, data = PFAS_NA, overall="Total")
...
PFAS_ARG <- aregImpute(~ mom_firstperiod_12y + vig_pre_d + mod_pre_d + ahei_ffq1_n2128 + 
...
table1(~ age_mom_enroll_d + mom_firstperiod_12y + bmi_mom_prepreg_d + fish_d_f1 + 
         dark_meat_f1 + ahei_ffq1_n2128 + mod_pre_d + vig_pre_d, data = PFAS_COMP, overall="Total")
