...
summary(PFAS$WT_RAV1)
PFAS$DPP_RAV1 <- ifelse(is.na(PFAS$WT_RAV1), PFAS$DPP_RAV1 == NA, PFAS$WT_RAV1)
summary(PFAS$DPP_RAV1)

summary(PFAS$AGE_RAV1)
summary(PFAS$WT_RAV1)
PFAS$AGE_RAV1 <- ifelse(is.na(PFAS$WT_RAV1), PFAS$AGE_RAV1 == NA, PFAS$WT_RAV1)
summary(PFAS$AGE_RAV1)

# VISIT 2 (EARLY CHILDHOOD)
summary(PFAS$DPP_RAV2)
summary(PFAS$WT_RAV2)
PFAS$DPP_RAV2 <- ifelse(is.na(PFAS$WT_RAV2), PFAS$DPP_RAV2 == NA, PFAS$WT_RAV2)
summary(PFAS$DPP_RAV2)

summary(PFAS$AGE_RAV2)
summary(PFAS$WT_RAV2)
PFAS$AGE_RAV2 <- ifelse(is.na(PFAS$WT_RAV2), PFAS$AGE_RAV2 == NA, PFAS$WT_RAV2)
summary(PFAS$AGE_RAV2)

# VISIT 3 (MID CHILDHOOD)
summary(PFAS$DPP_RAV3)
summary(PFAS$WT_RAV3)
PFAS$DPP_RAV3 <- ifelse(is.na(PFAS$WT_RAV3), PFAS$DPP_RAV3 == NA, PFAS$WT_RAV3)
summary(PFAS$DPP_RAV3)

summary(PFAS$AGE_RAV3)
summary(PFAS$WT_RAV3)
PFAS$AGE_RAV3 <- ifelse(is.na(PFAS$WT_RAV3), PFAS$AGE_RAV3 == NA, PFAS$WT_RAV3)
summary(PFAS$AGE_RAV3)

# VISIT 4 (MID TEEN)
summary(PFAS$DPP_RAV4)
summary(PFAS$WT_RAV4)
PFAS$DPP_RAV4 <- ifelse(is.na(PFAS$WT_RAV4), PFAS$DPP_RAV4 == NA, PFAS$WT_RAV4)
summary(PFAS$DPP_RAV4)

summary(PFAS$AGE_RAV4)
summary(PFAS$WT_RAV4)
PFAS$AGE_RAV4 <- ifelse(is.na(PFAS$WT_RAV4), PFAS$AGE_RAV4 == NA, PFAS$WT_RAV4)
summary(PFAS$AGE_RAV4)
...
PFAS_X <- subset(PFAS_X, select = c(aid, age_mom_enroll_d, bmi_mom_prepreg_d, coll_grad, gt70k, mom_firstperiod_1,
                                    married_cohab, pari_d, race2_mom_epi_epia_d, smokpreg_final_d))

##### SAVE DATASET
write.csv(PFAS_3, "C:/Users/jarva/Desktop/James-Todd Lab/P2.PFASandWeightTrajectories/Data/PFAS_CL.csv", row.names = T)
...
write_sas(PFAS_X, "C:/Users/jarva/Desktop/James-Todd Lab/P2.PFASandWeightTrajectories/Data/PFAS_X.sas7bdat")
