...
summary(PS_AGE0$a_wt)
m.a.age0 <- list(
  "PFOS" = glm(a_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + smoke +
                 parity + fish_s + married, family = gaussian, data = PS_AGE0),
  "PFOA" = glm(a_wt ~ L2PFOA + age_s + menar_s + race + bmi_cat + smoke +
                 parity + fish_s + married, family = gaussian, data = PS_AGE0),
  "PFNA" = glm(a_wt ~ L2PFNA + age_s + menar_s + race + bmi_cat + smoke +
                 parity + fish_s + married, family = gaussian, data = PS_AGE0),
...
modelsummary(m.a.age0, fmt = 2,
             estimate = "{estimate}{stars}",
             statistic = c("SE: {std.error}",
                           "95% CI: [{conf.low}, {conf.high}]"),
             coef_omit = "Interc", title = "PFAS vs. WEIGHT TRAJECTORY MAGNITUDE (AGE 0)")


summary(PS_AGE1$a_wt)
m.a.age1 <- list(
  "PFOS" = glm(a_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + smoke +
                 parity + fish_s + married, family = gaussian, data = PS_AGE1),
  "PFOA" = glm(a_wt ~ L2PFOA + age_s + menar_s + race + bmi_cat + smoke +
                 parity + fish_s + married, family = gaussian, data = PS_AGE1),
  "PFNA" = glm(a_wt ~ L2PFNA + age_s + menar_s + race + bmi_cat + smoke +
                 parity + fish_s + married, family = gaussian, data = PS_AGE1),
...
modelsummary(m.a.age1, fmt = 2,
             estimate = "{estimate}{stars}",
             statistic = c("SE: {std.error}",
                           "95% CI: [{conf.low}, {conf.high}]"),
             coef_omit = "Interc", title = "PFAS vs. WEIGHT TRAJECTORY MAGNITUDE (AGE 1)")
...
modelsummary(m.c.age0, fmt = 2,
             estimate = "{estimate}{stars}",
             statistic = c("SE: {std.error}",
                           "95% CI: [{conf.low}, {conf.high}]"),
             coef_omit = "Interc", title = "PFAS vs. WEIGHT TRAJECTORY VELOCITY (AGE 0)")


summary(PS_AGE1$c_wt)
m.c.age1 <- list(
  "PFOS" = glm(c_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + smoke +  
                 parity + fish_s + married, family = gaussian, data = PS_AGE1),
  "PFOA" = glm(c_wt ~ L2PFOA + age_s + menar_s + race + bmi_cat + smoke +  
...
modelsummary(m.c.age1, fmt = 2,
             estimate = "{estimate}{stars}",
             statistic = c("SE: {std.error}",
                           "95% CI: [{conf.low}, {conf.high}]"),
             coef_omit = "Interc", title = "PFAS vs. WEIGHT TRAJECTORY VELOCITY (AGE 1)")
