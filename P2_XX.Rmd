...
library("olsrr")
m1 <- lm(a_wt ~ age + menar + fish + darkmeat + bmi_cat + parity + smoke + income + 
           race + edu + married, data = PFAS_WT)
ols_step_best_subset(m1)

m2 <- lm(c_wt ~ age + menar + fish + darkmeat + bmi_cat + parity + smoke + income + 
           race + edu + married, data = PFAS_WT)
...
```{r}
ad.lnm.bmi <- list(
 "1" = glm(BMI ~ L2PFOS + age_enroll + race + income + menar + smoke +
                parity + married, family = gaussian, data = PFAS_A),
 
 "2" = glm(BMI ~ L2PFOS + age_enroll + race + smoke + bmi_cat +
                parity + married + darkmeat + income + fish, family = gaussian, data = PFAS_A),
 
 "3" = glm(BMI ~ L2PFOS + age_enroll + race + smoke + bmi_cat +
                parity + married + income + fish, family = gaussian, data = PFAS_A),
 
 "4" = glm(BMI ~ L2PFOS + age_enroll + race + smoke + bmi_cat + edu +
                parity + married + income + fish, family = gaussian, data = PFAS_A),
 
 "5" = glm(BMI ~ L2PFOS + age_enroll + race + income + menar + smoke +
                   parity + bmi_cat + fish, family = gaussian, data = PFAS_A),
 
 "6" = glm(BMI ~ L2PFOS + age_enroll + race + income + menar + smoke +
                   parity + bmi_cat + darkmeat, family = gaussian, data = PFAS_A))
...
ad.lnm.bmi <- list(
 ...
 "2" = glm(BMI ~ L2PFOS + age_enroll + race + smoke + bmi +
                parity + married + darkmeat + income + fish, family = gaussian, data = PFAS_A),
 
 "3" = glm(BMI ~ L2PFOS + age_enroll + race + smoke + bmi +
                parity + married + income + fish, family = gaussian, data = PFAS_A),
 
 "4" = glm(BMI ~ L2PFOS + age_enroll + race + smoke + bmi + edu +
                parity + married + income + fish, family = gaussian, data = PFAS_A),
 
 "5" = glm(BMI ~ L2PFOS + age_enroll + race + income + menar + smoke +
                   parity + bmi + fish, family = gaussian, data = PFAS_A),
 
 "6" = glm(BMI ~ L2PFOS + age_enroll + race + income + menar + smoke +
                   parity + bmi + darkmeat, family = gaussian, data = PFAS_A))
...
ad.lnm.trk <- list(
 "1" = glm(TrnkFat ~ L2PFOS + age_enroll + race + smoke + mom_height_ma17 + bmi_cat +
                parity + married + income + fish, family = gaussian, data = PFAS_D),
 
 "2" = glm(TrnkFat ~ L2PFOS + age_enroll + race + mom_height_ma17 + bmi_cat +
                parity + married + income + fish, family = gaussian, data = PFAS_D),
 
 "3" = glm(TrnkFat ~ L2PFOS + age_enroll + race + smoke + mom_height_ma17 + bmi_cat +
                parity + married + income + fish, family = gaussian, data = PFAS_D),
 
 "4" = glm(TrnkFat ~ L2PFOS + age_enroll + race + smoke + mom_height_ma17 + bmi_cat +
                parity + married + income + fish, family = gaussian, data = PFAS_D),
 
 "5" = glm(TrnkFat ~ L2PFOS + age_enroll + race + smoke + mom_height_ma17 + bmi_cat +
                parity + married + income + fish, family = gaussian, data = PFAS_D),
 
 "6" = glm(TrnkFat ~ L2PFOS + age_enroll + race + smoke + mom_height_ma17 + bmi_cat +
                parity + married + income + fish, family = gaussian, data = PFAS_D))

modelsummary(ad.lnm.trk, fmt = 4,
            estimate = "{estimate}{stars}",
            statistic = c("SE: {std.error}",
                          "95% CI: [{conf.low}, {conf.high}]"),
...
```{r}
PFAS_SYS$L2PFOS <- log(PFAS_SYS$PFOS, 2)
PFAS_SYS$L2PFOA <- log(PFAS_SYS$PFOA, 2)
PFAS_SYS$L2PFNA <- log(PFAS_SYS$PFNA2, 2)
PFAS_DIAS$L2PFOS <- log(PFAS_DIAS$PFOS, 2)
PFAS_DIAS$L2PFOA <- log(PFAS_DIAS$PFOA, 2)
PFAS_DIAS$L2PFNA <- log(PFAS_DIAS$PFNA2, 2)

ad.lnm.asys <- list(
 "1" = glm(a_sys ~ L2PFOS  + age + race + smoke + bmi_cat +
                parity + menar + income + fish + darkmeat, family = gaussian, data = PFAS_SYS),
 
 "2" = glm(a_sys ~ L2PFOS  + age + race + smoke + bmi_cat +
                parity + menar + income + fish, family = gaussian, data = PFAS_SYS),
 
 "3" = glm(a_sys ~ L2PFOS  + age + race + smoke + bmi_cat +
                parity + income + fish, family = gaussian, data = PFAS_SYS),
 
 "4" = glm(a_sys ~ L2PFOS  + age + race + smoke + bmi_cat +
                parity + income + fish + darkmeat, family = gaussian, data = PFAS_SYS))

modelsummary(ad.lnm.asys, fmt = 4,
            estimate = "{estimate}{stars}",
            statistic = c("SE: {std.error}",
                          "95% CI: [{conf.low}, {conf.high}]"),
            coef_omit = "Interc", title = "LN-PFAS vs. SIZE, SYS")

ad.lnm.asys <- list(
 "1" = glm(a_sys ~ L2PFOS  + age + race + smoke + bmi +
                parity + menar + income + fish + darkmeat, family = gaussian, data = PFAS_SYS),
 
 "2" = glm(a_sys ~ L2PFOS  + age + race + smoke + bmi +
                parity + menar + income + fish, family = gaussian, data = PFAS_SYS),
 
 "3" = glm(a_sys ~ L2PFOS  + age + race + smoke + bmi +
                parity + income + fish, family = gaussian, data = PFAS_SYS),
 
 "4" = glm(a_sys ~ L2PFOS  + age + race + smoke + bmi +
                parity + income + fish + darkmeat, family = gaussian, data = PFAS_SYS))
...
ad.lnm.csys <- list(
 "1" = glm(c_sys ~ L2PFNA + age + race + smoke + bmi_cat +
                parity + menar + income + fish + darkmeat, family = gaussian, data = PFAS_SYS),
 
 "2" = glm(c_sys ~ L2PFNA + age + race + smoke + bmi_cat +
                parity + menar + income + fish, family = gaussian, data = PFAS_SYS),
 
 "3" = glm(c_sys ~ L2PFNA + age + race + smoke + bmi_cat +
                parity + income + fish, family = gaussian, data = PFAS_SYS),
 
 "4" = glm(c_sys ~ L2PFNA + age + race + smoke + bmi_cat +
                parity + income + fish + darkmeat, family = gaussian, data = PFAS_SYS))

modelsummary(ad.lnm.csys, fmt = 4,
            estimate = "{estimate}{stars}",
            statistic = c("SE: {std.error}",
                          "95% CI: [{conf.low}, {conf.high}]"),
            coef_omit = "Interc", title = "LN-PFAS vs. VELOCITY, SYS")


ad.lnm.adias <- list(
 "1" = glm(a_dias ~ L2PFNA + age + race + smoke + bmi_cat +
                parity + menar + income + fish + darkmeat, family = gaussian, data = PFAS_DIAS),
 
 "2" = glm(a_dias ~ L2PFNA + age + race + smoke + bmi_cat +
                parity + menar + income + fish, family = gaussian, data = PFAS_DIAS),
 
 "3" = glm(a_dias ~ L2PFNA + age + race + smoke + bmi_cat +
                parity + income + fish, family = gaussian, data = PFAS_DIAS),
 
 "4" = glm(a_dias ~ L2PFNA + age + race + smoke + bmi_cat +
                parity + income + fish + darkmeat, family = gaussian, data = PFAS_DIAS))

modelsummary(ad.lnm.adias, fmt = 4,
            estimate = "{estimate}{stars}",
            statistic = c("SE: {std.error}",
                          "95% CI: [{conf.low}, {conf.high}]"),
            coef_omit = "Interc", title = "LN-PFAS vs. SIZE, DIAS")


ad.lnm.cdias <- list(
 "1" = glm(c_dias ~ L2PFNA + age + race + smoke + bmi_cat +
                parity + menar + income + fish + darkmeat, family = gaussian, data = PFAS_DIAS),
 
 "2" = glm(c_dias ~ L2PFNA + age + race + smoke + bmi_cat +
                parity + menar + income + fish, family = gaussian, data = PFAS_DIAS),
 
 "3" = glm(c_dias ~ L2PFNA + age + race + smoke + bmi_cat +
                parity + income + fish, family = gaussian, data = PFAS_DIAS),
 
 "4" = glm(c_dias ~ L2PFNA + age + race + smoke + bmi_cat +
                parity + income + fish + darkmeat, family = gaussian, data = PFAS_DIAS))

modelsummary(ad.lnm.cdias, fmt = 4,
            estimate = "{estimate}{stars}",
            statistic = c("SE: {std.error}",
                          "95% CI: [{conf.low}, {conf.high}]"),
            coef_omit = "Interc", title = "LN-PFAS vs. VELOCITY, DIAS")
