...
##### COMBINED EXERCISE VARIABLES
PFAS_IPW_NA$exer <- PFAS_IPW_NA$mod_pre_d + PFAS_IPW_NA$vig_pre_d
...
# summary(PFAS_IPW_NA$ahei_ffq1_n2128)
# summary(PFAS_IPW_NA$ahei_ffq2_n2128)
summary(PFAS_IPW_NA$mod_pre_d)
summary(PFAS_IPW_NA$vig_pre_d)
summary(PFAS_IPW_NA$exer)
...
table1(~ age_mom_enroll_d + mom_firstperiod_12y + bmi_mom_prepreg_d + fish_d_f1 + 
         dark_meat_f1 + mod_pre_d + vig_pre_d + exer, data = PFAS_IPW_NA, overall="Total")
...
```{r}
##### CLEAN AND SUMMARIZE MAIN DATASET #####

##### COMBINED EXERCISE VARIABLES
PFAS_NA$exer <- PFAS_NA$mod_pre_d + PFAS_NA$vig_pre_d
...
# summary(PFAS_NA$ahei_ffq1_n2128)
# summary(PFAS_NA$ahei_ffq2_n2128)
summary(PFAS_NA$mod_pre_d)
summary(PFAS_NA$vig_pre_d)
summary(PFAS_NA$exer)
...
##### TABLE OF MISSINGNESS
table1(~ age_mom_enroll_d + mom_firstperiod_12y + bmi_mom_prepreg_d + fish_d_f1 + 
         dark_meat_f1 + mod_pre_d + vig_pre_d + exer, data = PFAS_NA, overall="Total")
...
PFAS_IPW_ARG <- aregImpute(~ mom_firstperiod_12y + vig_pre_d + mod_pre_d + 
                         fish_d_f1 + dark_meat_f1 + income_hh_epq_epqa_d +
                         gt70k + married_cohab + coll_grad + race2_mom_epi_epia_d +
                         smokpreg_final_d + bmi_mom_prepreg_d + bmi_cat + parity_d + 
                         g_age_days_COLL_D_BLD1 + age_mom_enroll_d + PFOS + PFOA + 
                         PFNA + PFHxS + MeFOSAA + EtFOSAA, nk = 0, data = PFAS_IPW_NA, n.impute = 5)
...
PFAS_ARG <- aregImpute(~ mom_firstperiod_12y + vig_pre_d + mod_pre_d + 
                         fish_d_f1 + dark_meat_f1 + income_hh_epq_epqa_d +
                         gt70k + married_cohab + coll_grad + race2_mom_epi_epia_d +
                         smokpreg_final_d + bmi_mom_prepreg_d + bmi_cat + parity_d + 
                         g_age_days_COLL_D_BLD1 + age_mom_enroll_d + PFOS + PFOA + 
                         PFNA + PFHxS + MeFOSAA + EtFOSAA, nk = 0, data = PFAS_NA, n.impute = 5)
...
# PFAS_BIND$DPP_SR14 <- ifelse(is.na(PFAS_BIND$DPP_SR14), 9999, PFAS_BIND$DPP_SR14)
# PFAS_BIND$DPP_SR15 <- ifelse(is.na(PFAS_BIND$DPP_SR15), 9999, PFAS_BIND$DPP_SR15)
# PFAS_BIND$DPP_SR16 <- ifelse(is.na(PFAS_BIND$DPP_SR16), 9999, PFAS_BIND$DPP_SR16)
...
# PFAS_BIND$WTK_SR14 <- ifelse(is.na(PFAS_BIND$WTK_SR14), 9999, PFAS_BIND$WTK_SR14)
# PFAS_BIND$WTK_SR15 <- ifelse(is.na(PFAS_BIND$WTK_SR15), 9999, PFAS_BIND$WTK_SR15)
# PFAS_BIND$WTK_SR16 <- ifelse(is.na(PFAS_BIND$WTK_SR16), 9999, PFAS_BIND$WTK_SR16)
...
# PFAS_COMP$DPP_SR14 <- ifelse(PFAS_COMP$DPP_SR14 == 9999, NA, PFAS_COMP$DPP_SR14)
# PFAS_COMP$DPP_SR15 <- ifelse(PFAS_COMP$DPP_SR15 == 9999, NA, PFAS_COMP$DPP_SR15)
# PFAS_COMP$DPP_SR16 <- ifelse(PFAS_COMP$DPP_SR16 == 9999, NA, PFAS_COMP$DPP_SR16)
...
# PFAS_COMP$WTK_SR14 <- ifelse(PFAS_COMP$WTK_SR14 == 9999, NA, PFAS_COMP$WTK_SR14)
# PFAS_COMP$WTK_SR15 <- ifelse(PFAS_COMP$WTK_SR15 == 9999, NA, PFAS_COMP$WTK_SR15)
# PFAS_COMP$WTK_SR16 <- ifelse(PFAS_COMP$WTK_SR16 == 9999, NA, PFAS_COMP$WTK_SR16)
...
table1(~ age_mom_enroll_d + mom_firstperiod_12y + bmi_mom_prepreg_d + fish_d_f1 + 
         dark_meat_f1 + mod_pre_d + vig_pre_d, data = PFAS_COMP, overall="Total")

table1(~ race2_mom_epi_epia_d + bmi_cat + gt70k + parity_cat + married_cohab + 
         smokpreg_final_d + coll_grad, data = PFAS_COMP, overall="Total")
...
# write_sas(PFAS_IPW_COMP, "C:/Users/jarva/Desktop/James-Todd Lab/P2.PFASandWeightTrajectories/Data/PFAS_IPW_COMP.sas7bdat")
...
# write_sas(PFAS_COMP, "C:/Users/jarva/Desktop/James-Todd Lab/P2.PFASandWeightTrajectories/Data/PFAS_COMP.sas7bdat")
