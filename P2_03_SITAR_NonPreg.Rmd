...
```{r}
##### LOAD DATASET
PFAS <- read.csv("C:/Users/jarva/Desktop/James-Todd Lab/P2.PFASandWeightTrajectories/Data/PFAS_NONPREG.csv")
...
summary(m1_wt)
71.16519 - 1.96*0.740949
71.16519 + 1.96*0.740949

-0.37143 - 1.96*0.209734
-0.37143 + 1.96*0.209734
...
plot(m1_wt, opt = 'dv', las = 1, col = "deepskyblue3", lwd = 3, 
     y2par = list(col = 'navyblue', lwd = 3, lty = 5), ylim = c(68,81),
