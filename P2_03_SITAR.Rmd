...
##### LOAD WORKSPACE
load("C:/Users/jarva/Desktop/James-Todd Lab/P2.PFASandWeightTrajectories/Data/P2_SITAR2.Rdata")
...
summary(SITAR$WT_2)
summary(SITAR$WT_1)
meanWT <- mean(SITAR$WT_13, na.rm = T) - mean(SITAR$WT_2, na.rm = T)
sd(meanWT)
...
outliers_dpp <- velout(x = DPP, y = WEIGHT, id = aid, data = SITAR_L, limit = 5)
...
# save(m1_wt, file="C:/Users/jarva/Desktop/James-Todd Lab/P2.PFASandWeightTrajectories/Data/P2_SITAR2.Rdata")
