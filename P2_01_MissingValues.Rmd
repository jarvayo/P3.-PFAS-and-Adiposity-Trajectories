...
```{r}
##### LOAD DATASET
PFAS_NA <- read.sas7bdat("C:/Users/jarva/Desktop/James-Todd Lab/P2.PFASandWeightTrajectories/Data/PFAS.sas7bdat")
...
table(PFAS_NA$LOD_PFOS)
table(PFAS_NA$LOD_PFOA)
table(PFAS_NA$LOD_PFNA)
table(PFAS_NA$LOD_PFHxS)
table(PFAS_NA$LOD_MeF)
table(PFAS_NA$LOD_EtF)
...
summary(PFAS_BIND$WT_RAV1)
summary(PFAS_BIND$WT_RAV2)
summary(PFAS_BIND$WT_RAV3)
summary(PFAS_BIND$WT_RAV4)
...
summary(PFAS_COMP$WT_RAV1)
summary(PFAS_COMP$WT_RAV2)
summary(PFAS_COMP$WT_RAV3)
summary(PFAS_COMP$WT_RAV4)
ls(PFAS_COMP)
