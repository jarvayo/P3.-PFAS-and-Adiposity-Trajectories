...
table1(~ age_enroll + gestage_enroll + menar + bmi + bmi_cat + race +  income + parity + smoke + 
         married + edu + fish + darkmeat + AHEI + exer, data = PFAS, overall = "Total")
...
PFAS_X$AHEI <- PFAS_X$ahei_ffq1_n2128
...
label(PFAS_X$AHEI) <- "AHEI-P"
label(PFAS_X$exer) <- "Exercise"
...
units(PFAS_X$exer) <- "hours/week"


##### TABE 1
table1(~ age_enroll + menar + bmi + bmi_cat + race +  income + parity + smoke + 
         married + edu + fish + darkmeat + AHEI + exer, data = PFAS_X, overall = "Total")
