...
```{r}
##### LOAD DATASET
PFAS_NA <- read.sas7bdat("C:/Users/jarva/Desktop/James-Todd Lab/P2.PFASandWeightTrajectories/Data/PFAS_CL.sas7bdat")
...
table1(~ age_mom_enroll_d + mom_firstperiod_12y + bmi_mom_prepreg_d, data = PFAS_NA, overall="Total")
...
PFAS_ARG <- aregImpute(~ gt70k + mom_firstperiod_12y + married_cohab + coll_grad + 
                         race2_mom_epi_epia_d + smokpreg_final_d + bmi_mom_prepreg_d + 
                         bmi_cat + parity_d + g_age_days_COLL_D_BLD1 + age_mom_enroll_d + 
...
table1(~ age_mom_enroll_d + mom_firstperiod_12y + bmi_mom_prepreg_d, data = PFAS_COMP, overall="Total")
...
```{r}
##### SAVE DATASET
write.csv(PFAS_COMP, file = "C:/Users/jarva/Desktop/James-Todd Lab/P2.PFASandWeightTrajectories/Data/PFAS_COMP.csv", row.names = T)
