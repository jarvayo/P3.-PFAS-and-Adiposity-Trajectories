...
```{r}
##### DELETE WEIGHT MEASUREMENTS TAKEN DURING PREGNANCY
# VISIT 1 (6 MONTH PP)
...
PFAS_3 <- subset(PFAS_2, RAWT1_AVAIL == 1) # HAS >= 1 RA-MEASURED WEIGHT MEASURE 
PFAS_4 <- subset(PFAS_2, RAWT2_AVAIL == 1) # HAS >= 2 RA-MEASURED WEIGHT MEASURE 
PFAS_5 <- subset(PFAS_2, RAWT3_AVAIL == 1) # HAS >= 2 RA-MEASURED WEIGHT MEASURE 
PFAS_6 <- subset(PFAS_2, RAWT4_AVAIL == 1) # HAS >= 2 RA-MEASURED WEIGHT MEASURE 
...
PFAS_3$include <- 1+0
PFAS1_X <- merge(PFAS, PFAS_3, by = "aid", all.x = TRUE)
PFAS1_X <- subset(PFAS1_X, is.na(include))

colnames(PFAS1_X)<-gsub(".y","",colnames(PFAS1_X))
colnames(PFAS1_X)<-gsub(".x","",colnames(PFAS1_X))
...
PFAS1_X <- subset(PFAS1_X, select = c(aid, age_mom_enroll_d, bmi_mom_prepreg_d, coll_grad, gt70k, mom_firstperiod_1,
...
##### SAVE DATASET
write_sas(PFAS_3, "C:/Users/jarva/Desktop/James-Todd Lab/P2.PFASandWeightTrajectories/Data/PFAS1_CL.sas7bdat")
...
write_sas(PFAS1_X, "C:/Users/jarva/Desktop/James-Todd Lab/P2.PFASandWeightTrajectories/Data/PFAS1_X.sas7bdat")
write.csv(PFAS1_X, "C:/Users/jarva/Desktop/James-Todd Lab/P2.PFASandWeightTrajectories/Data/PFAS1_X.csv", row.names = T)
write_sas(PFAS2_X, "C:/Users/jarva/Desktop/James-Todd Lab/P2.PFASandWeightTrajectories/Data/PFAS2_X.sas7bdat")
