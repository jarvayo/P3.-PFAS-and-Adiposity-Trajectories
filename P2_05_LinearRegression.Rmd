...
```{r}
ad.m.a <- list(
  "1" = glm(a_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + income + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),

  "2" = glm(a_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + income + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),

  "3" = glm(a_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + income + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),

  "4" = glm(a_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + income + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),

  "5" = glm(a_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + income + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),

  "6" = glm(a_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + income + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT))
...
ad.m.c <- list(
  "1" = glm(c_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + income + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),

  "2" = glm(c_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + income + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),

  "3" = glm(c_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + income + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),

  "4" = glm(c_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + income + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),

  "5" = glm(c_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + income + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),

  "6" = glm(c_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + income + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT))
...
# WEIGHT TRAJECTORY MAGNITUDE
ad.m.a <- list(
  "PFOS" = glm(a_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "PFOA" = glm(a_wt ~ L2PFOA + age_s + menar_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "PFNA" = glm(a_wt ~ L2PFNA + age_s + menar_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "PFHxS" = glm(a_wt ~ L2PFHxS + age_s + menar_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "MeFOSAA" = glm(a_wt ~ L2MeFOSAA + age_s + menar_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "EtFOSAA" = glm(a_wt ~ L2EtFOSAA + age_s + menar_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT))
...
# ad.lme.a <- list(
#   "PFOS" = glm(Intercept ~ L2PFOS + age_s + menar_s + race + bmi_cat + income + smoke +  
#                  parity + fish_s + married, family = gaussian, data = PFAS_LME),
#   "PFOA" = glm(Intercept ~ L2PFOA + age_s + menar_s + race + bmi_cat + income + smoke +  
#                  parity + fish_s + married, family = gaussian, data = PFAS_LME),
#   "PFNA" = glm(Intercept ~ L2PFNA + age_s + menar_s + race + bmi_cat + income + smoke +  
#                  parity + fish_s + married, family = gaussian, data = PFAS_LME),
#   "PFHxS" = glm(Intercept ~ L2PFHxS + age_s + menar_s + race + bmi_cat + income + smoke +  
#                  parity + fish_s + married, family = gaussian, data = PFAS_LME),
#   "MeFOSAA" = glm(Intercept ~ L2MeFOSAA + age_s + menar_s + race + bmi_cat + income + smoke +  
#                  parity + fish_s + married, family = gaussian, data = PFAS_LME),
#   "EtFOSAA" = glm(Intercept ~ L2EtFOSAA + age_s + menar_s + race + bmi_cat + income + smoke +  
#                  parity + fish_s + married, family = gaussian, data = PFAS_LME))
# 
# modelsummary(ad.lme.a, fmt = 4,
#              estimate = "{estimate}{stars}",
#              statistic = c("SE: {std.error}",
#                            "95% CI: [{conf.low}, {conf.high}]"),
#              coef_omit = "Interc", title = "PFAS vs. WEIGHT MAGNITUDE")
...
ad.m.c <- list(
  "PFOS" = glm(c_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "PFOA" = glm(c_wt ~ L2PFOA + age_s + menar_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "PFNA" = glm(c_wt ~ L2PFNA + age_s + menar_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "PFHxS" = glm(c_wt ~ L2PFHxS + age_s + menar_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "MeFOSAA" = glm(c_wt ~ L2MeFOSAA + age_s + menar_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "EtFOSAA" = glm(c_wt ~ L2EtFOSAA + age_s + menar_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT))
...
# WEIGHT TRAJECTORY MAGNITUDE
ad.m.a2 <- list(
  "PFOS" = glm(a_wt ~ L2PFOS + age_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "PFOA" = glm(a_wt ~ L2PFOA + age_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "PFNA" = glm(a_wt ~ L2PFNA + age_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "PFHxS" = glm(a_wt ~ L2PFHxS + age_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "MeFOSAA" = glm(a_wt ~ L2MeFOSAA + age_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "EtFOSAA" = glm(a_wt ~ L2EtFOSAA + age_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT))

modelsummary(ad.m.a2, fmt = 4,
             estimate = "{estimate}{stars}",
             statistic = c("SE: {std.error}",
                           "95% CI: [{conf.low}, {conf.high}]"),
             coef_omit = "Interc", title = "PFAS vs. WEIGHT MAGNITUDE")
...
# WEIGHT TRAJECTORY VELOCITY
ad.m.c2 <- list(
  "PFOS" = glm(c_wt ~ L2PFOS + age_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "PFOA" = glm(c_wt ~ L2PFOA + age_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "PFNA" = glm(c_wt ~ L2PFNA + age_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "PFHxS" = glm(c_wt ~ L2PFHxS + age_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "MeFOSAA" = glm(c_wt ~ L2MeFOSAA + age_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
  "EtFOSAA" = glm(c_wt ~ L2EtFOSAA + age_s + race + bmi_cat + income + smoke +  
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT))

modelsummary(ad.m.c2, fmt = 4,
             estimate = "{estimate}{stars}",
             statistic = c("SE: {std.error}",
                           "95% CI: [{conf.low}, {conf.high}]"),
             coef_omit = "Interc", title = "PFAS vs. WEIGHT VELOCITY")
