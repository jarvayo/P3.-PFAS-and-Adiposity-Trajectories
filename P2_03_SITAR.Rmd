...
SITAR_DPP$DPP <- SITAR_DPP$DPP/365
# SITAR_AGE$AGE <- SITAR_AGE$AGE/365 
...
## SET 115 WEIGHT OUTLIERS MISSING
SIT_DPP <- zapvelout(outliers_dpp, icode = c(4, 6))
...
```{r}
##### FIT SITAR MODEL
m1_wt <- sitar(x = DPP, y = WEIGHT, id = aid, df = 2, data = SIT_DPP, fixed='a+c', random='a+c')
