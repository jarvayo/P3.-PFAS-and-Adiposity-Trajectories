...
table1(~ age_mom_enroll_d + mom_firstperiod_12y + bmi_mom_prepreg_d + fish_d_f1 + 
         dark_meat_f1 + ahei_ffq1_n2128, data = PFAS_NA, overall="Total")
...
PFAS_ARG <- aregImpute(~ gt70k + mom_firstperiod_12y + ahei_ffq1_n2128 + fish_d_f1 + dark_meat_f1 + 
...
table1(~ age_mom_enroll_d + mom_firstperiod_12y + bmi_mom_prepreg_d + fish_d_f1 + 
         dark_meat_f1 + ahei_ffq1_n2128, data = PFAS_COMP, overall="Total")
