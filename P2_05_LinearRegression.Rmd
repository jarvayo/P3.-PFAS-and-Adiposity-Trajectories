...
```{r}
ad.m.a <- list(
  "1" = glm(a_wt ~ L2PFOS + age_s  + race + bmi_cat  + smoke + darkmeat_s +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),

  "2" = glm(a_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat  + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),

  "3" = glm(a_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + edu + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),
...
ad.m.c <- list(
  "1" = glm(c_wt ~ L2PFOS + age_s  + race + bmi_cat  + smoke +darkmeat_s +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),

  "2" = glm(c_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat  + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),

  "3" = glm(c_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + edu + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),

  "4" = glm(c_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat + darkmeat_s + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT),

  "5" = glm(c_wt ~ L2PFOS + age_s + menar_s + race + bmi_cat  + smoke +
                 parity + darkmeat_s + married, family = gaussian, data = PFAS_SIT),

  "6" = glm(c_wt ~ L2PFOS + age_s + edu + race + bmi_cat  + smoke +
                 parity + fish_s + married, family = gaussian, data = PFAS_SIT))
